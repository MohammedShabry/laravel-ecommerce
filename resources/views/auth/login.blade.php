...
<head>
    ...
    <style>
        ...
        /* Added: compact circular social icon buttons */
        .social-btn {
            width: 44px;
            height: 44px;
            padding: 0;
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="email" type="email" name="email" class="form-control" placeholder="Username or email" value="{{ old('email') }}" required autofocus>
                </div>

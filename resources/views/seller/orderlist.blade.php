...
@section('content')
                ...
                <!-- Add clickable-row behavior and cleanup dropdown items -->
                <style>
                    /* clickable rows show pointer */
                    .table tbody tr.clickable-row { cursor: pointer; }
                </style>

                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        // Make each table row clickable and redirect to /seller/orderdetail
                        document.querySelectorAll('.table tbody tr').forEach(function (tr) {
                            // mark as clickable for styling
                            tr.classList.add('clickable-row');
                            tr.addEventListener('click', function (e) {
                                // Prevent redirect when clicking inside dropdown or its menu
                                if (e.target.closest('.dropdown') || e.target.closest('.dropdown-menu')) {
                                    return;
                                }
                                window.location.href = '/seller/orderdetail';
                            });
                        });

                        // Prevent dropdown toggle clicks from bubbling to the row click
                        ...
                        // Remove "View detail" and "Edit info" items from dropdown menus
                        document.querySelectorAll('.dropdown-menu a').forEach(function (a) {
                            var txt = (a.textContent || '').trim().toLowerCase();
                            if (txt === 'view detail' || txt === 'edit info' || txt === 'edit info') {
                                a.remove();
                            }
                        });
                    });

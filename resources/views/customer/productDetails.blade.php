                                ...
                                <div class="row related-products">
                                        ...
                                        <div class="product-cart-wrap hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="{{ route('customer.productdetails') }}" tabindex="0">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ route('customer.productdetails') }}" tabindex="0">Ulstra Bass Headphone</a></h2>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap hover-up">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ route('customer.productdetails') }}" tabindex="0">Smart Bluetooth Speaker</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span> </span>
                                                </div>
                                                <div class="product-price">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap hover-up">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ route('customer.productdetails') }}" tabindex="0">HomeSpeak 12UEA Goole</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span> </span>
                                                </div>
                                                <div class="product-price">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6 d-lg-block d-none">
                                        <div class="product-cart-wrap hover-up mb-0">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ route('customer.productdetails') }}" tabindex="0">Dadua Camera 4K 2024EF</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span> </span>
                                                </div>
                                                <div class="product-price">

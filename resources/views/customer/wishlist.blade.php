                            ...
                            <tbody>
                                <tr class="pt-30">
                                    ...
                                    <td class="product-des product-name">
                                        <h6><a class="product-name mb-10" href="{{ route('customer.productdetails') }}">Field Roast Chao Cheese Creamy Original</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td class="product-des product-name">
                                        <h6><a class="product-name mb-10" href="{{ route('customer.productdetails') }}">Blue Diamond Almonds Lightly Salted</a></h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="product-des product-name">
                                        <h6><a class="product-name mb-10" href="{{ route('customer.productdetails') }}">Fresh Organic Mustard Leaves Bell Pepper</a></h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="product-des product-name">
                                        <h6><a class="product-name mb-10" href="{{ route('customer.productdetails') }}">Angie’s Boomchickapop Sweet & Salty </a></h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="product-des product-name">
                                        <h6><a class="product-name mb-10" href="{{ route('customer.productdetails') }}">Foster Farms Takeout Crispy Classic</a></h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>

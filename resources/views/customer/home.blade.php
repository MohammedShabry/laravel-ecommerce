                    ...
                    <div class="col-lg-2 d-none d-lg-flex">
                        <div class="categories-dropdown-wrap style-2 font-heading mt-30">
                            <div class="d-flex categori-dropdown-inner">
                                <ul>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-1.svg') }}" alt="" />Milks and Dairies</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-2.svg') }}" alt="" />Clothing & beauty</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-3.svg') }}" alt="" />Pet Foods & Toy</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-4.svg') }}" alt="" />Baking material</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-5.svg') }}" alt="" />Fresh Fruit</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-6.svg') }}" alt="" />Wines & Drinks</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-7.svg') }}" alt="" />Fresh Seafood</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-8.svg') }}" alt="" />Fast food</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-9.svg') }}" alt="" />Vegetables</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-10.svg') }}" alt="" />Bread and Juice</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/category-3.svg') }}" alt="" />Pet Foods & Toy</a>
                                    </li>
                            ...
                            <div class="more_slide_open" style="display: none">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/icon-1.svg') }}" alt="" />Milks and Dairies</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/icon-2.svg') }}" alt="" />Clothing & beauty</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/icon-3.svg') }}" alt="" />Wines & Drinks</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('customer.shopgrid') }}"> <img src="{{ asset('assets/imgs/theme/icons/icon-4.svg') }}" alt="" />Fresh Seafood</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-10">
                        <div class="home-slide-cover mt-30">
                            <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                                <div class="single-hero-slider single-animation-wrap" style="background-image: url('{{ asset('assets/imgs/slider/slider-1.png') }}')">
                ...
                <div class="section-title">
                    <div class="title">
                        ...
                        <ul class="list-inline nav nav-tabs links">
                            <li class="list-inline-item nav-item"><a class="nav-link" href="{{ route('customer.shopgrid') }}">Cake & Milk</a></li>
                            <li class="list-inline-item nav-item"><a class="nav-link" href="{{ route('customer.shopgrid') }}">Coffes & Teas</a></li>
                            <li class="list-inline-item nav-item"><a class="nav-link active" href="{{ route('customer.shopgrid') }}">Pet Foods</a></li>
                            <li class="list-inline-item nav-item"><a class="nav-link" href="{{ route('customer.shopgrid') }}">Vegetables</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="carausel-10-columns" id="carausel-10-columns">
                        <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-13.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Cake & Milk</a></h6>
                            <span>26 items</span>
                        </div>
                        <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-12.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Oganic Kiwi</a></h6>
                            <span>28 items</span>
                        </div>
                        <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-11.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Peach</a></h6>
                            <span>14 items</span>
                        </div>
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-9.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Red Apple</a></h6>
                            <span>54 items</span>
                        </div>
                        <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-3.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Snack</a></h6>
                            <span>56 items</span>
                        </div>
                        <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-1.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Vegetables</a></h6>
                            <span>72 items</span>
                        </div>
                        <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-2.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Strawberry</a></h6>
                            <span>36 items</span>
                        </div>
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-4.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Black plum</a></h6>
                            <span>123 items</span>
                        </div>
                        <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-5.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Custard apple</a></h6>
                            <span>34 items</span>
                        </div>
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-14.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Coffe & Tea</a></h6>
                            <span>89 items</span>
                        </div>
                        <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{ route('customer.shopgrid') }}"><img src="{{ asset('assets/imgs/shop/cat-15.png') }}" alt="" /></a>
                            </figure>
                            <h6><a href="{{ route('customer.shopgrid') }}">Headphone</a></h6>
                            <span>87 items</span>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('customer.productdetails') }}">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Seeds of Change Organic Quinoa, Brown, & Red Rice</a></h2>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">All Natural Italian-Style Chicken Meatballs</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Angie’s Boomchickapop Sweet & Salty Kettle Corn</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Foster Farms Takeout Crispy Classic Buffalo Wings</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Blue Diamond Almonds Lightly Salted Vegetables</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Chobani Complete Vanilla Greek Yogurt</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Canada Dry Ginger Ale – 2 L Bottle - 200ml - 400g</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Encore Seafoods Stuffed Alaskan Salmon</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Gorton’s Beer Battered Fish Fillets with soft paper</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('customer.productdetails') }}">Haagen-Dazs Caramel Cone Ice Cream Ketchup</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">

                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <a href="{{ route('customer.wishlist') }}"><span class="lable">Wishlist</span></a>
                                </div>
                                <div class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="{{ route('customer.cart') }}">
                                        <img alt="Nest" src="{{ asset('assets/imgs/theme/icons/icon-cart.svg') }}" />
                                        <span class="pro-count blue">2</span>
                                    </a>
                                    <a href="{{ route('customer.cart') }}"><span class="lable">Cart</span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        ...
                                        <div class="shopping-cart-footer">
                                            ...
                                            <div class="shopping-cart-button">
                                                <a href="{{ route('customer.cart') }}" class="outline">View cart</a>
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            <li>
                                                <a href="{{ route('customer.myaccount') }}"><i class="fi fi-rs-user mr-10"></i>My Account</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('customer.home') }}"><i class="fi fi-rs-location-alt mr-10"></i>Order Tracking</a>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fi fi-rs-label mr-10"></i>My Voucher</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('customer.wishlist') }}"><i class="fi fi-rs-heart mr-10"></i>My Wishlist</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('customer.myaccount') }}"><i class="fi fi-rs-settings-sliders mr-10"></i>Setting</a>
                                            </li>
                                            <li>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a class="{{ request()->routeIs('customer.about') ? 'active' : '' }}" href="{{ route('customer.about') }}">About</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.allproducts') }}">Shop</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.vendors') }}">Vendors</a>
                                    </li>
                                    <!-- Mega menu removed -->
                                    <!-- Blog menu removed -->
                                    <!-- 'Pages' menu removed -->
                                    <li>
                                       <a class="{{ request()->routeIs('customer.contact') ? 'active' : '' }}" href="{{ route('customer.contact') }}">Contact</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
